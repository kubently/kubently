...
def create_api_key_middleware(
    auth_module, skip_paths: dict[str, list] | None = None, error_format: str = "json"
) -> AuthMiddleware:
    """
    ...
    return AuthMiddleware(
        auth_validator=validator, skip_paths=skip_paths, error_format=error_format
    )
...
__all__ = ["AuthMiddleware", "create_api_key_middleware", "create_bearer_token_middleware"]
